function SkeletonSidebar() {
  ...
  return (
    <aside className="flex flex-col h-full bg-white lg:bg-transparent px-4 w-full lg:w-[18%] text-center lg:text-left animate-pulse fixed translate-x-[-100%] lg:translate-x-0">
